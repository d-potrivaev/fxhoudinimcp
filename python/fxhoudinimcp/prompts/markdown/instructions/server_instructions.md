Houdini MCP: 207 tools across 23 categories. Full rules: get_workflow_guide("discipline"), read once per session before building.
...
6. No CTRL null by default; knobs go on the HDA/subnet interface if there is one.
7. ISOLATE while iterating: display only what you work on.
...
10. Between steps, one line to the user: what was done, what comes next.
{layout_guidance}
